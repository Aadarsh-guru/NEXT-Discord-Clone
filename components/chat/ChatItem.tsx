...
const ChatItem = ({ id, isUpdated, content, currentMember, timestamp, fileUrl, deleted, socketQuery, socketUrl, member }: ChatItemProps) => {
            ...
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isImage && (
                        ...
                        >
                            <Image src={fileUrl} alt={content} fill objectFit='cover' />
                        </a>
                    )}
                    {isPDF && (
                    ...
                    {!fileUrl && isEditing && (
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className='flex items-center w-full gap-x-2 pt-2'>
                                ...
                                />
                                <Button disabled={isLoaing} variant={'primary'} size={'sm'} >
                                    Save
                                </Button>
                            </form>
